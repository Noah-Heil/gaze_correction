...
model_config.add_argument("--P_IDP", type=eval, default=6.2, help="")
model_config.add_argument("--f", type=eval, default=400, help="")
model_config.add_argument("--P_c_x", type=eval, default=12.7, help="")
model_config.add_argument("--P_c_y", type=eval, default=-26.67, help="")
model_config.add_argument("--P_c_z", type=eval, default=-1, help="")
model_config.add_argument("--S_W", type=eval, default=93.98, help="")
model_config.add_argument("--S_H", type=eval, default=53.34, help="")
# model_config.add_argument("--P_c_x", type=eval, default=26.4, help="")
# model_config.add_argument("--P_c_y", type=eval, default=-16.5, help="")
# model_config.add_argument("--P_c_z", type=eval, default=-1, help="")
# model_config.add_argument("--S_W", type=eval, default=105.156, help="")
